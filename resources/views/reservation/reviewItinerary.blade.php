                        ...
                        <div class="content">>
                            ...
                            @if($reservation->other_details)
                                ...
                                <div class="input-group form-group-no-border input-lg{{ $errors->has('other_details') ? ' has-error' : '' }}">
                                    <textarea id="other_details" name="other_details" type="text" class="form-control" disabled rows="4" placeholder="Other details for the reservation" style="color: white">{{$reservation->other_details}}</textarea>
                                </div>
                            @endif
                            <div>
