                        ...
                        <div class="row offset-1">
                            ...
                            <div class="col-sm-4" style="display: inline-block;">
                                {!! Form::open(['method'=>'GET', 'action'=> 'ReservationController@searchUserReservation']) !!}
                                    {!! Form::text('userSearch', null, ['class'=>'form-control', 'placeholder'=>'Search user\'s reservation', 'style'=>'color: purple;']) !!}
                            </div>
                            <div class="col-sm-2">
                                    {!! Form::submit('Search', ['class'=>'btn btn-primary btn-round']) !!}
                                {!! Form::close() !!}
                            </div>
                        </div>
